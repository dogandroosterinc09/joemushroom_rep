...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="{{ url('admin/faqs') }}">Blog Category Archive</a></li>
        <li><span href="javascript:void(0)">Add New Blog Category</span></li>
    </ul>
    ...
    <div class="block full">
        <div class="">
            <form method="POST" id="form" action="{{ route('storeFaqs') }}"  enctype="multipart/form-data">
            @csrf

            <div class="block-title">
                <h2><i class="fa fa-pencil"></i> <strong>Add new Faqs</strong></h2>
            </div>
            <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                    <h4 style="border-left: 3px solid #61dbd5; padding-left: 8px; margin-bottom: 20px;">FAQS</h4>
                </div>
            </div>
