...
.img-container:hover .middle {
  opacity: 1;
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><span href="javascript:void(0)">Edit Facility</span></li>
    </ul>
    
    <div class="block full">
        <form method="POST" id="form" action="{{ route('updateFacility', $facility->id) }}" enctype="multipart/form-data">
        @csrf
                <div class="block-title">
                    <h2><i class="fa fa-pencil"></i> <strong>Edit Facility "{{ $facility->title }}"</strong></h2>
                </div>
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h4 style="border-left: 3px solid #61dbd5; padding-left: 8px; margin-bottom: 20px;">Facility Details</h4>
                    </div>
                </div>
                        ...
                        <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                ...
                                <textarea id="content" name="content" rows="9"
                                            ...
                                            placeholder="Enter Content ..">{{ $facility->content }}</textarea>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-group{{ $errors->has('photo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                ...
                                <a href="{{ url('public/'.$facility->photo) }}" class="zoom img-thumbnail" style="cursor: default !important;" data-toggle="lightbox-image">
                                    <img src="{{ asset('public/'.$facility->photo) }}" alt="{{ $facility->title }}" class="img-responsive center-block" style="max-width: 100px;">
                                </a>
                            </div>
                        </div>
                    </div>
