(function () {
    ...
    function _fileselect(element, numFiles, label, ext) {
        ...
        if (element.val() == '') {
            ...
            if (ext == 'jpeg' || ext == 'jpg' || ext == 'png' || ext == 'docx' || ext == 'pdf' || ext == 'doc') {
                ...
                _fileselect_error(element, input, 'The upload file must be a file of type: jpeg, jpg, png, docx, pdf, doc');
            }
        }
    }
